...
\newcommand{\newchapter}[2]
{
	\subsection{#1}\subfile{revisedsections/#2}\noindent\rule[0.5ex]{\linewidth}{1pt}\subfile{revisedwalkthroughs/#2}\noindent\rule[0.5ex]{\linewidth}{1pt}\subfile{revisedproblems/#2}\noindent\rule[0.5ex]{\linewidth}{1pt}\vspace{.125in}
}
...
\subsection{The Squeeze Theorem}\subfile{revisedsections/SqueezeTheorem}\noindent\rule[0.5ex]{\linewidth}{1pt}\subfile{revisedwalkthroughs/SqueezeTheorem}\noindent\rule[0.5ex]{\linewidth}{1pt}\vspace{.125in}
...
\subsection{Units}\subfile{revisedsections/DerivativeUnits}\noindent\rule[0.5ex]{\linewidth}{1pt}\subfile{revisedproblems/DerivativeUnits}\noindent\rule[0.5ex]{\linewidth}{1pt}
\subsection{Instantaneous Rate of Change}\subfile{revisedsections/InstantaneousRateOfChange}\noindent\rule[0.5ex]{\linewidth}{1pt}\subfile{revisedwalkthroughs/InstantaneousRateOfChange}\noindent\rule[0.5ex]{\linewidth}{1pt}
